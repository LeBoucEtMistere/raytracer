...
Benchmarks are run on this binary:
...
```bash
hyperfine target/release/raytracer --export-markdown benchmarks/results.md --min-runs 2
```

## Results

Adding the BVH optimisation yielded an improvement of rendertime of 263% :yay:
